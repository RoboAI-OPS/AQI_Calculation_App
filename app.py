...
def add_device_ui():
    ...
    add_password = st.sidebar.text_input(
        "Password",
        type="password",
        key="add_password"
    )
    ...
    if st.sidebar.button("Add Device"):
        ...
        if add_password != ADMIN_PASSWORD:
...
# =========================================================
# EDIT DEVICE (PASSWORD PROTECTED)
# =========================================================
def edit_device_ui():
    ...
    if device_keys:
        ...
        edit_password = st.sidebar.text_input(
            "Password",
            type="password",
            key="edit_password"
        )
...
# =========================================================
# DELETE DEVICE (PASSWORD PROTECTED)
# =========================================================
def delete_device_ui():
    ...
    if device_keys:
        ...
        delete_password = st.sidebar.text_input(
            "Password",
            type="password",
            key="delete_password"
        )
